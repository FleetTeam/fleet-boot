<template>
  <a-row class="f-select-dev-component-box" type="flex" :gutter="8">
...
<script>
import FSelectDevComponentModal from './FSelectDevComponentModal'

export default {
  name: 'FSelectDevComponent',
  components: { FSelectDevComponentModal },
  props: {
    value: {
      type: String,
      default: '',
