package org.fleet.common.util.jsonschema;
...
public class JsonschemaUtil {
	...
	public static JSONObject getJsonSchema(JsonSchemaDescrip descrip, List<CommonProperty> propertyList) {
		...
		//鬼知道这里为什么报错 org.fleet.modules.system.model.DictModel cannot be cast to org.fleet.modules.system.model.DictModel
