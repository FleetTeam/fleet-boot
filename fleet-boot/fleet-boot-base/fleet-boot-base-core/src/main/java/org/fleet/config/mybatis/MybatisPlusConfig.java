package org.fleet.config.mybatis;
...
/**
 * 单数据源配置（fleet.datasource.open = false时生效）
 *
 * @Author fleet-team
 */
@Configuration
@MapperScan(value = {"org.fleet.modules.**.mapper*"})
public class MybatisPlusConfig {
    ...
    private void tenantConfig(PaginationInterceptor paginationInterceptor) {
        ...
        TenantSqlParser tenantSqlParser = new FleetTenantParser();
