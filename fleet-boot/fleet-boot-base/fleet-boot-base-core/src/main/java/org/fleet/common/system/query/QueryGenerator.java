package org.fleet.common.system.query;
...
import org.fleet.common.system.vo.SysPermissionDataRuleModel;
import org.fleet.common.system.util.FleetDataAutorUtils;
...
import org.fleet.common.util.SqlInjectionUtil;
...
public class QueryGenerator {
	 ...
	 * <br>错误示例:如QueryWrapper<FleetDemo> queryWrapper = new QueryWrapper<FleetDemo>(fleetDemo);
	 * <br>正确示例:QueryWrapper<FleetDemo> queryWrapper = new QueryWrapper<FleetDemo>();
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap() {
		...
		List<SysPermissionDataRuleModel> list = FleetDataAutorUtils.loadDataSearchConditon();
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap(List<SysPermissionDataRuleModel> list) {
		Map<String, SysPermissionDataRuleModel> ruleMap = new HashMap<String, SysPermissionDataRuleModel>();
		if(list==null){
			list = FleetDataAutorUtils.loadDataSearchConditon();
		}
		if(list != null&&list.size()>0){
			if(list.get(0)==null){
				return ruleMap;
