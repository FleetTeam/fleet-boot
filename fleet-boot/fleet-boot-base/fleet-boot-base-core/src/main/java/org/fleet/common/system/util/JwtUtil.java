package org.fleet.common.system.util;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws FleetBootException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws FleetBootException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new FleetBootException("未获取到用户");
		}
		return username;
	}
	...
	public static String getUserSystemData(String key, SysUserCacheInfo user) {
		if(user==null) {
			user = FleetDataAutorUtils.loadUserInfo();
		}
		//#{sys_user_code}%
