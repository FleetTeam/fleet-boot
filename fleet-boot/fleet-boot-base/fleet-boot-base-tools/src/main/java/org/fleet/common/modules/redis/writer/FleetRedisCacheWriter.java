package org.fleet.common.modules.redis.writer;
 ...
 */
@Slf4j
public class FleetRedisCacheWriter implements RedisCacheWriter {

    private final RedisConnectionFactory connectionFactory;
    private final Duration sleepTime;

    public FleetRedisCacheWriter(RedisConnectionFactory connectionFactory) {
        this(connectionFactory, Duration.ZERO);
    }

    public FleetRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
