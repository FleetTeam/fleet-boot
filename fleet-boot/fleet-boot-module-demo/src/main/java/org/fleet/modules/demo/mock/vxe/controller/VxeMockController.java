package org.fleet.modules.demo.mock.vxe.controller;
...
import org.fleet.common.constant.VXESocketConst;
import org.fleet.common.system.query.MatchTypeEnum;
import org.fleet.common.system.query.QueryCondition;
import org.fleet.common.system.query.QueryGenerator;
import org.fleet.modules.demo.mock.vxe.entity.MockEntity;
import org.fleet.modules.demo.mock.vxe.websocket.VXESocket;
...
public class VxeMockController {
    ...
    public Result getMockData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:org/fleet/modules/demo/mock/vxe/json/dlglong.json";
        // 读取JSON数据
    ...
    public Result getMockDdjhData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:org/fleet/modules/demo/mock/vxe/json/ddjh.json";
        if ("8".equals(status)) {
            path = "classpath:org/fleet/modules/demo/mock/vxe/json/ddjh_s8.json";
        }
        // 读取JSON数据
        JSONArray dataList = readJsonData(path);
        if (dataList == null) {
