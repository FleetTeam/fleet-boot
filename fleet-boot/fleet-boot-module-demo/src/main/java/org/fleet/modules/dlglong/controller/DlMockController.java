package org.fleet.modules.dlglong.controller;
...
import org.fleet.modules.dlglong.entity.MockEntity;
...
public class DlMockController {
    ...
    public Result getMockData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:org/fleet/modules/dlglong/json/dlglong.json";
        // 读取JSON数据
    ...
    public Result getMockDdjhData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:org/fleet/modules/dlglong/json/ddjh.json";
        if ("8".equals(status)) {
            path = "classpath:org/fleet/modules/dlglong/json/ddjh_s8.json";
        }
        // 读取JSON数据
        JSONArray dataList = readJsonData(path);
        if (dataList == null) {
