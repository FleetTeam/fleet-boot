//package org.fleet;
//
//import org.fleet.modules.demo.mock.MockController;
...
//
//	@Resource
//	private FleetDemoMapper jeecgDemoMapper;
//	@Resource
//	private IFleetDemoService jeecgDemoService;
////	@Resource
...
//		List<FleetDemo> userList = jeecgDemoMapper.selectList(null);
...
//		System.out.println(("----- selectAll method test ------"));
//		List<FleetDemo> userList = jeecgDemoMapper.getDemoByName("Sandy12");
//		userList.forEach(System.out::println);
//	}
//
//	/**
