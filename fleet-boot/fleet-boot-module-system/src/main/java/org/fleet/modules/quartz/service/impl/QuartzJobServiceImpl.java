...
import org.fleet.modules.quartz.mapper.QuartzJobMapper;
import org.fleet.modules.quartz.service.IQuartzJobService;
import org.quartz.*;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
    ...
    private void schedulerAdd(String jobClassName, String cronExpression, String parameter) {
        try {
            ...
            throw new FleetBootException("创建定时任务失败", e);
        } catch (RuntimeException e) {
            throw new FleetBootException(e.getMessage(), e);
        } catch (Exception e) {
            throw new FleetBootException("后台找不到该类名：" + jobClassName, e);
        }
    }
    ...
    private void schedulerDelete(String jobClassName) {
        try {
            ...
            throw new FleetBootException("删除定时任务失败");
        }
    }
